...
// Example 2
function myFunc2(iMyFunc: IMyFunc) {
    const array: string[] = [iMyFunc.string1, iMyFunc.string2, iMyFunc.string3]
    return array;
}

const myfunc: IMyFunc = { string1: "d", string2: "e", string3: "f" };
...
function myFunc3(iMyFunc: IMyFunc) {
    const array: string[] = [iMyFunc.string1.toUpperCase(), iMyFunc.string2.toUpperCase(), iMyFunc.string3.toUpperCase()]
    return array;
}

const myfunc2: IMyFunc = { string1: "d", string2: "e", string3: "f" };
